	...
	'inline-flex items-center justify-center whitespace-nowrap rounded-md !text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:disabled:pointer-events-none disabled:opacity-50',
	{
		...
		compoundVariants: [
			...
			},
			{
				color: 'default',
				variant: 'link',
				className: cn('hover:!text-primary', 'disabled:pointer-events-none disabled:opacity-50'),
			},
			{
				color: 'primary',
				variant: 'link',
			...
			},
			{
				color: 'secondary',
				variant: 'link',
				className: cn('hover:!text-secondary', 'disabled:pointer-events-none disabled:opacity-50'),
			},
			{
				color: 'destructive',
				variant: 'link',
				className: cn('hover:!text-destructive', 'disabled:pointer-events-none disabled:opacity-50'),
			},
			{
				color: 'warning',
				variant: 'link',
				className: cn('hover:!text-warning', 'disabled:pointer-events-none disabled:opacity-50'),
			},
			{
				color: 'success',
				variant: 'link',
				className: cn('hover:!text-success', 'disabled:pointer-events-none disabled:opacity-50'),
			},
			{
				color: 'mode',
				variant: 'link',
			...
			},
			{
				color: 'muted',
				variant: 'link',
				className: cn('hover:!text-muted', 'disabled:pointer-events-none disabled:opacity-50'),
			},
		],
	}
);
...
export interface ButtonProps
	...
	asChild?: boolean;
	color?: 'default' | 'primary' | 'secondary' | 'destructive' | 'warning' | 'success' | 'mode' | 'muted';
}
