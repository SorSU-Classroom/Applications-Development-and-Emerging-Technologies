...
<img src="https://zod.dev/icon.png?39fe259ddd7f4224" alt="Zod" width="64px" className="p-4 mx-auto" loading="lazy" style={{ background: "white" }} />
...
<img src="https://miro.medium.com/v2/1*8pLiWUrglmnzfBYf1XJ4TA.jpeg" alt="Yup" width="64px" className="p-4 mx-auto" loading="lazy" style={{ background: "white" }} />
...
| **Async Validation** | <CheckIcon /> | <CheckIcon /> | <CheckIcon /> |
| **Custom Validation** | <CheckIcon /> | <CheckIcon /> | <CheckIcon /> |
