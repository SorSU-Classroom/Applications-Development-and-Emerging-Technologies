...
<img src="https://mma.prnewswire.com/media/551541/Mapbox_Logo.jpg?p=facebook" alt="Mapbox" width="128px" className="p-4 mx-auto" loading="lazy" style={{ background: "white" }} />
...
<img src="https://maplibre.org/img/maplibre-logo-big.svg" alt="MapLibre" width="128px" className="p-4 mx-auto" loading="lazy" style={{ background: "white" }} />
...
<img src="https://miro.medium.com/v2/0*yfKeaZGzJ59p9AsG.png" alt="TipTap" width="96px" className="p-4 mx-auto" loading="lazy" style={{ background: "white" }} />
